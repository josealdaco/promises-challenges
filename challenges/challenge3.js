 ...
 *
 *  We recieve the HELLO THERE DUCKY after pending for promise
...
async function greetAndUppercase(name) {
    ...
    result = await spacer(uppercasedGreeting)  // Our function is now being called asynchronously
    return result
}
